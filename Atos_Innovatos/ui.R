    ...
    tabItems(
      ...
      tabItem(tabName = "Upload",
              fluidRow(
                box(title = "What is this?", status = "primary", solidHeader = TRUE,width = 12,
                    tags$p("In This Section  Upload any data set and submit")
                )),
              fluidRow(
      ...
      tabItem(tabName = "CaseOverview",
             ...
             # fluidRow(
               # box(title = "Select Column", status = "primary", solidHeader = TRUE,width = 10
                    #selectInput("selectVarNameForCase",label = "Variable:",choices = NULL),
                   # uiOutput("overviewSelector")
      ...
      tabItem(tabName = "ExploreDensity",
             ...
             # fluidRow(
              ...
              #      #selectInput("selectVarNameForDensity",label = "Variable:",choices = all_column() )
               #     uiOutput("densitySelectInput")
              #  )
             # ),
              fluidRow(
                htmlOutput("den"),
                box(title = "Selection 2nd variable", status = "primary", solidHeader = TRUE,width = 12,
                    #selectInput("selectVarNameForDensity1",label = "Variable:",choices = all_column() )
